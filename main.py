...
#          1) open link to dataset to show options to enter comma separated list
#          2) input github repo -> scrape and merge data
#          3) enter comma separated list of owner/repoName -> scrape and merge data
from model import recommend
from data.data_processing import prepare_data, fetch_repos
import asyncio
...
print("3 = manually enter IDs of available GitHub repos from a list of the top 980")
# selection = 2
selection = int(input())
...
if selection == 1:
    ...
    loop.run_until_complete(fetch_repos(["dapr/dapr"]))
